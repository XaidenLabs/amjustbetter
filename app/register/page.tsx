                    ...
                    <div className="space-y-4 rounded-md shadow-sm">
                        <div>
                            <input
                                ...
                                className="relative block w-full rounded-md border-0 py-3 text-foreground ring-1 ring-inset ring-input placeholder:text-muted-foreground focus:z-10 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6 bg-background px-3"
